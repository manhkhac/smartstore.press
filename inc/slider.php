			...
			<div class="section group">
				...
				<div class="listview_1_of_2 images_1_of_2">
				    ...
				    <div class="text list_2_of_1">
						<h2>Lenovo</h2>
						<p><?php echo $fm->textShorten($resultLenovo['productName'],35) ?></p>
						<div class="button"><span><a href="details.php?proid=<?php echo $resultLenovo['productId'] ?>">Thêm vào giỏ</a></span></div>
				   </div>
			   </div>
			   <?php
				}}
