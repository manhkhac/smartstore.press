...
<style>
	...
	#xuatExcel >li{
		width: 100px;height: 25px;cursor: pointer;background: white; text-align: center;position: relative;list-style: none;
	}
	#xuatExcel >li:hover a{
		background: red;
		list-style: none;
	}
</style>
        ...
        <div class="grid_10">
            <div class="box round first grid">
                ...
                if (isset($del_shifted)) {
                 ...
                 ?> 
                 <div id="xuatExcel"><a href="../admin/export-an-excel/export.php"><li>Xuất Excel</a></li></div>       
					...
					<tbody>
						...
						<tr class="odd gradeX">
							...
							<td><a href="inhd.php?customerid=<?php echo $result['customer_id'] ?> "target="_blank">Xuất hoá đơn</a></td>
						</tr>
						<?php 
						}
						}
